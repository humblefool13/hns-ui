      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm font-inter text-gray-600 dark:text-gray-300 transition-colors duration-300">
                    The coolest domain registry on Abstract. Search, mint, and
                    flex your hotdog identity with style.
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-lg font-inter text-foreground font-semibold mb-4 transition-colors duration-300">
                Quick Links
              </h4>
              <ul className="space-y-2">
                <li>
                  <a
                    href="#discover"
                    className="text-gray-500 dark:text-gray-400 hover:text-green-500 transition-colors font-inter"
                  >
                    Discover Domains
                  </a>
                </li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-center md:text-left mb-4 md:mb-0">
              <p className="text-sm font-inter text-gray-500 dark:text-gray-400 transition-colors duration-300">
                © 2025 HotDog Name Service. All rights reserved. Made with 🌭 +
                ❤️ by the HotDogs team
              </p>
            </div>
