...
export default function GuidePage() {
  const quickStartSteps = [
    ...
    },
    {
      ...
      description: "Set up resolvers, records, and other domain settings",
      icon: "⚙️",
    },
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Registration costs vary based on the name length and popularity. Most names cost between 0.1 to 2 ABSTRACT tokens, with premium names costing more.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "If you don't renew your domain before expiration, it becomes available for others to register. Make sure to set up auto-renewal or mark your calendar!",
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-green-500 transition-all duration-300 cursor-pointer group">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Learn about domains, resolvers, and the naming system
                architecture
              </p>
            ...
            <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-green-500 transition-all duration-300 cursor-pointer group">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Security guidelines and best practices for managing your domains
              </p>
              <button className="flex items-center gap-2 text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 transition-colors duration-300">
                Read More <ExternalLink size={16} />
              </button>
